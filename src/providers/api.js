import { UsersApi, PayingApi, TeachingApi, StudentsFileApi } from '@haapi/typescript-client'
...
export const studenstFileApi = () => new StudentsFileApi(authProvider.getCachedAuthConf())
